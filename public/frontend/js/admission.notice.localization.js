...
const translations = {
    ...
    bn: {
        ...
        // -----Admission Notice-----//
        admissionNotice:"ভর্তি বিজ্ঞপ্তি",
        admissionNoticeHome:"হোম"
    }
};
...
function loadLanguage() {
    ...
    document.querySelectorAll('.admissionNotice').forEach(el => el.textContent = data.admissionNotice);
    document.querySelectorAll('.admissionNoticeHome').forEach(el => el.textContent = data.admissionNoticeHome);
