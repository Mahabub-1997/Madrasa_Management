...
const translations = {
    en: {
        ...
        contactSubtitle1:"Home",
        contactSubtitle2:"Contact",
        contactInfo:"contactInfo",
        contactAddress:"Contact Address",
        Address:"140 azampur khacha Bazar Dakshin Khan  uttara Dhaka 1230",
    ...
    bn: {
        ...
        contactSubtitle1:"হোম",
        contactSubtitle2:"যোগাযোগ",
        contactInfo:"যোগাযোগের তথ্য",
        contactAddress:"যোগাযোগের ঠিকানা",
        Address:"মুসলিহুল উম্মাহ হিফজ মাদ্রাসা " +
            "১৪০ আজমপুর কাঁচা বাজার, দক্ষিণখান,উত্তরা, ঢাকা -১২৩০",
...
function loadLanguage() {
    ...
    document.querySelectorAll('.contactTitle').forEach(el => el.textContent = data.contactTitle);
    document.querySelectorAll('.contactSubtitle1').forEach(el => el.textContent = data.contactSubtitle1);
    document.querySelectorAll('.contactSubtitle2').forEach(el => el.textContent = data.contactSubtitle2);
    document.querySelectorAll('.contactInfo').forEach(el => el.textContent = data.contactInfo);
    document.querySelectorAll('.contactAddress').forEach(el => el.textContent = data.contactAddress);
    document.querySelectorAll('.Address').forEach(el => el.textContent = data.Address);
    document.querySelectorAll('.ContactPhone').forEach(el => el.textContent = data.ContactPhone);
    document.querySelectorAll('.Phone').forEach(el => el.textContent = data.Phone);
    document.querySelectorAll('.contactEmail').forEach(el => el.textContent = data.contactEmail);
    document.querySelectorAll('.ContactUs').forEach(el => el.textContent = data.ContactUs);
